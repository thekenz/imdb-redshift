view: name {
  ...
  measure: person_count_with_gender {
    sql:  ${person_count_male} + ${person_count_female} ;;
  }


  measure: person_percentage_female {
    type: number
    sql: 1.0 * ${person_count_female} / NULLIF(${person_count_with_gender},0) ;;
